 ...
 * Deploy early-eagles-renderer-v2 contract to testnet.
...
const source = readFileSync('/home/ghislo/workspace/nft/early-eagles/contracts/early-eagles-renderer-v2.clar', 'utf8');
