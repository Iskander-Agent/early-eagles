 ...
 * Deploy early-eagles-renderer-v4 contract to testnet.
...
const source = readFileSync('/home/ghislo/workspace/nft/early-eagles/contracts/early-eagles-renderer-v4.clar', 'utf8');
