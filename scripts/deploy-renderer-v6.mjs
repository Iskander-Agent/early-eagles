/**
 * Deploy early-eagles-renderer-v6 and immediately set all segments.
...
const NEW_RENDERER = 'early-eagles-renderer-v6';
...
const clarityCode = readFileSync('/home/ghislo/workspace/nft/early-eagles/contracts/early-eagles-renderer-v6.clar', 'utf8');
