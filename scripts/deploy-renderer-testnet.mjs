 ...
 * Deploy early-eagles-renderer contract to testnet.
 * Run once. Then run set-renderer-data-testnet.mjs to upload the segments.
 */
...
const source = readFileSync('/home/ghislo/workspace/nft/early-eagles/contracts/early-eagles-renderer.clar', 'utf8');
...
console.log('  node scripts/set-renderer-data-testnet.mjs');
