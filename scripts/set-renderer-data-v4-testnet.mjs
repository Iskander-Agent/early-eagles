 ...
 * Run after early-eagles-renderer-v4 is deployed and confirmed.
...
console.log('Contract:', `${address}.early-eagles-renderer-v4\n`);

// Check renderer is deployed
const ifaceRes = await fetch(`${API}/v2/contracts/interface/${address}/early-eagles-renderer-v4`);
if (!ifaceRes.ok) {
...
const lockedRes = await fetch(`${API}/v2/contracts/call-read/${address}/early-eagles-renderer-v4/is-locked`, {
  method: 'POST',
...
async function callFn(fnName, arg, fee = 600000n) {
  ...
  const tx = await makeContractCall({
    ...
    contractName: 'early-eagles-renderer-v4',
    functionName: fnName,
