 ...
 * Run after early-eagles-renderer-v3 is deployed and confirmed.
...
console.log('Contract:', `${address}.early-eagles-renderer-v3\n`);

// Check renderer is deployed
const ifaceRes = await fetch(`${API}/v2/contracts/interface/${address}/early-eagles-renderer-v3`);
if (!ifaceRes.ok) {
...
const lockedRes = await fetch(`${API}/v2/contracts/call-read/${address}/early-eagles-renderer-v3/is-locked`, {
  method: 'POST',
